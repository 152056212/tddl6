package com.github.mySequence.common.model.hint;

import com.github.mySequence.client.RouteCondition;
import com.github.mySequence.common.model.sqljep.Comparative;
import com.github.mySequence.common.model.sqljep.ComparativeMapChoicer;
...
public class RuleRouteCondition extends ExtraCmdRouteCondition implements RouteCondition, ComparativeMapChoicer {
     ...
     * 
     * @param key 参数项名字
     * @param parameter 参数项值，一般为基本类型或可比较类型
     */
