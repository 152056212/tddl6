package com.github.mySequence.common.mock;
...
import com.github.mySequence.common.exception.NotSupportException;
...
public class MockConnection implements Connection {
    ...
    public void commit() throws SQLException {
        ...
        checkClose();
        MockDataSource.record(new MockDataSource.ExecuteInfo(mockDataSource, "commit", null, null));
        commitInvokingTimes++;
    }
    ...
    public void rollback() throws SQLException {
        mockDataSource.checkState();
        checkClose();
        MockDataSource.record(new MockDataSource.ExecuteInfo(mockDataSource, "rollback", null, null));
    ...
    public void rollback(Savepoint savepoint) throws SQLException {
        mockDataSource.checkState();
        checkClose();
        MockDataSource.record(new MockDataSource.ExecuteInfo(mockDataSource, "rollback#savepoint", null, new Object[] { savepoint }));
        rollbackInvotingTimes++;
    }
    ...
    public void setAutoCommit(boolean autoCommit) throws SQLException {
        mockDataSource.checkState();
        checkClose();
        MockDataSource.record(new MockDataSource.ExecuteInfo(mockDataSource, "setAutoCommit", null, new Object[] { autoCommit }));
